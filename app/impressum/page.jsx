    ...
    <div className="page-content">
      <main>
        ...
        <div className="pt-5 mx-auto mb-5 text-center">
          ...
          <section>
            <p>
              <b>Registergericht:</b> Amtsgericht Nürnberg
              <br />
              <b>Registernummer:</b> VR 202972
            </p>
        ...
        <div className="pt-5 mx-auto mb-5">
          <div>
            <div>
              <h2 className="text-xl">1. Haftungsbeschränkung</h2>
              <p>
                ...
                Inhalte. Die Nutzung der Inhalte der Webseite erfolgt auf eigene
                Gefahr des Nutzers.
              </p>
              ...
              <p>
                ...
                wieder. Mit der reinen Nutzung der Webseite des Anbieters kommt
            ...
            <div>
              <h2 className="text-xl">2. Externe Links</h2>
              <p>
            ...
            <div>
              <h2 className="text-xl">3. Urheber- und Leistungsschutzrechte</h2>
              <p>
                ...
                Darstellung dieser Webseite in fremden Frames ist nur mit
